...
class BEREncoderSpec extends FlatSpec {
  ...
  "decoding and encoding a sequence 5" should "return the same thing" in {
    val bytes =
      ""
        .grouped(2)
        .map(Integer.parseInt(_, 16).toByte)
        .toArray
    val bb = new ByteStringBuilder()
  ...
  "decoding and encoding a sequence 6" should "return the same thing" in {
    val bytes =
      "3028020102632304000a01000a0100020100020100010100870b6f626a656374436c617373300304012a"
        .grouped(2)
        .map(Integer.parseInt(_, 16).toByte)
        .toArray
    val bb = new ByteStringBuilder()
  ...
  "decoding and encoding a sequence 7" should "return the same thing" in {
    val bytes =
      "3032020102632d04000a01010a0100020100020100010100870b6f626a656374436c617373300d040b6f626a656374436c617373"
        .grouped(2)
        .map(Integer.parseInt(_, 16).toByte)
        .toArray
    val bb = new ByteStringBuilder()
