...
class BEREncoderSpec extends FlatSpec {
  ...
  //    assert(decoded == Asn1Null())
  //    val encoded = BEREncoder.encode(decoded)
  //    assert(data == encoded)
  //  }
  ...
  //    println(encoded.map(_.toHexString).mkString(" "))
  //    assert(asn1 == decoded)
  //  }
  ...
  //    val asn1 = Asn1ContextSpecific(Array())
  //    val encoded = BEREncoder.encode(asn1)
  //    val decoded = BEREncoder.decode(encoded)
  //    assert(asn1 == decoded)
  //  }
